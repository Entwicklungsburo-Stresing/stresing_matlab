...
%This function was generated by loadlibrary.m parser version  on Tue Oct 11 16:59:45 2022
...
%  es_status_codes DLLCCDDrvInit ( UINT8 * _number_of_boards ); 
fcns.thunkname{fcnNum}='es_status_codesvoidPtrThunk';fcns.name{fcnNum}='DLLCCDDrvInit'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint8Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLCCDDrvExit ( UINT32 boad_sel ); 
fcns.thunkname{fcnNum}='es_status_codesuint32Thunk';fcns.name{fcnNum}='DLLCCDDrvExit'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32'};fcnNum=fcnNum+1;
...
%  es_status_codes DLLAbortMeasurement ( UINT32 drv ); 
fcns.thunkname{fcnNum}='es_status_codesuint32Thunk';fcns.name{fcnNum}='DLLAbortMeasurement'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32'};fcnNum=fcnNum+1;
%  es_status_codes DLLReturnFrame ( UINT32 drv , UINT32 curr_nos , UINT32 curr_nob , UINT16 curr_cam , UINT16 * pdioden , UINT32 length ); 
...
%  void DLLReadFFLoop (); 
fcns.thunkname{fcnNum}='voidThunk';fcns.name{fcnNum}='DLLReadFFLoop'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}=[];fcnNum=fcnNum+1;
...
%  es_status_codes DLLInitCamera3030 ( UINT32 drvno , UINT8 adc_mode , UINT16 custom_pattern , UINT8 adc_gain , UINT8 useDac , UINT32 * dac_output , UINT8 isIr ); 
...
structs.global_settings.members=struct('useSoftwarePolling', 'uint32', 'nos', 'uint32', 'nob', 'uint32', 'sti_mode', 'uint32', 'bti_mode', 'uint32', 'stime_in_microsec', 'uint32', 'btime_in_microsec', 'uint32', 'sdat_in_10ns', 'uint32', 'bdat_in_10ns', 'uint32', 'sslope', 'uint32', 'bslope', 'uint32', 'xckdelay_in_10ns', 'uint32', 'sec_in_10ns', 'uint32', 'trigger_mode_cc', 'uint32', 'board_sel', 'uint32', 'sensor_type', 'uint32', 'camera_system', 'uint32', 'camcnt', 'uint32', 'pixel', 'uint32', 'mshut', 'uint32', 'led_off', 'uint32', 'sensor_gain', 'uint32', 'adc_gain', 'uint32', 'Temp_level', 'uint32', 'dac', 'uint32', 'enable_gpx', 'uint32', 'gpx_offset', 'uint32', 'FFTLines', 'uint32', 'Vfreq', 'uint32', 'FFTMode', 'uint32', 'lines_binning', 'uint32', 'number_of_regions', 'uint32', 'keep', 'uint32', 'region_size', 'uint32#8', 'dac_output', 'uint32#40', 'TORmodus', 'uint32', 'ADC_Mode', 'uint32', 'ADC_custom_pattern', 'uint32', 'bec_in_10ns', 'uint32', 'cont_pause_in_microseconds', 'uint32', 'isIr', 'uint32', 'IOCtrl_impact_start_pixel', 'uint32', 'IOCtrl_output_width_in_5ns', 'uint32#8', 'IOCtrl_output_delay_in_5ns', 'uint32#8', 'IOCtrl_T0_period_in_10ns', 'uint32', 'dma_buffer_size_in_scans', 'uint32', 'tocnt', 'uint32', 'ticnt', 'uint32', 'use_ec', 'uint32');
