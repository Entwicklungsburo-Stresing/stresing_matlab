...
%This function was generated by loadlibrary.m parser version  on Tue Apr 18 15:18:31 2023
...
%  es_status_codes DLLReturnFrame ( uint32_t board_sel , uint32_t curr_nos , uint32_t curr_nob , uint16_t curr_cam , uint16_t * pdest0 , uint16_t * pdest1 , uint32_t length ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint32uint32uint16voidPtrvoidPtruint32Thunk';fcns.name{fcnNum}='DLLReturnFrame'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint32', 'uint32', 'uint16', 'uint16Ptr', 'uint16Ptr', 'uint32'};fcnNum=fcnNum+1;
%  es_status_codes DLLCopyAllData ( uint32_t board_sel , uint16_t * pdest0 , uint16_t * pdest1 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLCopyAllData'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint16Ptr', 'uint16Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLCopyOneBlock ( uint32_t board_sel , uint16_t block , uint16_t * pdest0 , uint16_t * pdest1 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint16voidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLCopyOneBlock'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint16', 'uint16Ptr', 'uint16Ptr'};fcnNum=fcnNum+1;
...
%  es_status_codes DLLCalcTrms ( uint32_t board_sel , uint32_t firstSample , uint32_t lastSample , uint32_t TRMS_pixel , uint16_t CAMpos , double * mwf0 , double * trms0 , double * mwf1 , double * trms1 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint32uint32uint32uint16voidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLCalcTrms'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint32', 'uint32', 'uint32', 'uint16', 'doublePtr', 'doublePtr', 'doublePtr', 'doublePtr'};fcnNum=fcnNum+1;
...
%  void DLLFillUserBufferWithDummyData ( uint32_t board_sel ); 
fcns.thunkname{fcnNum}='voiduint32Thunk';fcns.name{fcnNum}='DLLFillUserBufferWithDummyData'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}=[]; fcns.RHS{fcnNum}={'uint32'};fcnNum=fcnNum+1;
%  es_status_codes DLLAbout ( uint32_t board_sel ); 
...
%  es_status_codes DLLwaitForMeasureReady ( uint32_t board_sel ); 
...
%  es_status_codes DLLwaitForBlockReady ( uint32_t board_sel ); 
...
%  es_status_codes DLLisMeasureOn ( uint32_t board_sel , uint8_t * measureOn0 , uint8_t * measureOn1 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLisMeasureOn'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8Ptr', 'uint8Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLisBlockOn ( uint32_t board_sel , uint8_t * blockOn0 , uint8_t * blockOn1 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLisBlockOn'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8Ptr', 'uint8Ptr'};fcnNum=fcnNum+1;
%  void DLLGetCurrentScanNumber ( uint32_t board_sel , int64_t * sample , int64_t * block ); 
...
%  es_status_codes DLLOutTrigHigh ( uint32_t board_sel ); 
...
%  es_status_codes DLLOutTrigLow ( uint32_t board_sel ); 
...
%  es_status_codes DLLOutTrigPulse ( uint32_t board_sel , uint32_t PulseWidth ); 
...
%  es_status_codes DLLOpenShutter ( uint32_t board_sel ); 
...
%  es_status_codes DLLCloseShutter ( uint32_t board_sel ); 
...
%  es_status_codes DLLSetTemp ( uint32_t board_sel , uint8_t level ); 
...
%  es_status_codes DLLSetTORReg ( uint32_t board_sel , uint8_t tor ); 
...
%  es_status_codes DLLDAC8568_setAllOutputs ( uint32_t board_sel , uint8_t location , uint32_t * output0 , uint32_t * output1 , uint32_t * output2 , uint32_t * output3 , uint32_t * output4 , uint8_t reorder_channel ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint8voidPtrvoidPtrvoidPtrvoidPtrvoidPtruint8Thunk';fcns.name{fcnNum}='DLLDAC8568_setAllOutputs'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint8'};fcnNum=fcnNum+1;
%  es_status_codes DLLIOCtrl_setAllOutputs ( uint32_t board_sel , uint32_t * width_in_5ns , uint32_t * delay_in_5ns ); 
fcns.thunkname{fcnNum}='es_status_codesuint32voidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLIOCtrl_setAllOutputs'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint32Ptr', 'uint32Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLIOCtrl_setT0 ( uint32_t board_sel , uint32_t period_in_10ns ); 
...
%  es_status_codes DLLGetIsTdc ( uint32_t board_sel , uint8_t * isTdc0 , uint8_t * isTdc1 , uint8_t * isTdc2 , uint8_t * isTdc3 , uint8_t * isTdc4 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLGetIsTdc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8Ptr', 'uint8Ptr', 'uint8Ptr', 'uint8Ptr', 'uint8Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLGetIsDsc ( uint32_t board_sel , uint8_t * isDsc0 , uint8_t * isDsc1 , uint8_t * isDsc2 , uint8_t * isDsc3 , uint8_t * isDsc4 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32voidPtrvoidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLGetIsDsc'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8Ptr', 'uint8Ptr', 'uint8Ptr', 'uint8Ptr', 'uint8Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLResetDSC ( uint32_t board_sel , uint8_t DSCNumber ); 
...
%  es_status_codes DLLSetDIRDSC ( uint32_t board_sel , uint8_t DSCNumber , uint8_t dir ); 
...
%  es_status_codes DLLGetDSC ( uint32_t board_sel , uint8_t DSCNumber , uint32_t * ADSC0 , uint32_t * LDSC0 , uint32_t * ADSC1 , uint32_t * LDSC1 ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint8voidPtrvoidPtrvoidPtrvoidPtrThunk';fcns.name{fcnNum}='DLLGetDSC'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr'};fcnNum=fcnNum+1;
%  es_status_codes DLLInitGPX ( uint32_t board_sel , uint32_t delay ); 
...
%  es_status_codes DLLGetAllSpecialPixelInformation ( uint32_t board_sel , uint32_t sample , uint32_t block , uint16_t camera_pos , struct special_pixels * sp ); 
...
%  es_status_codes DLLreadRegisterS0_8 ( uint32_t board_sel , uint8_t * data , uint32_t address ); 
...
%  es_status_codes DLLwriteRegisterS0_8 ( uint32_t board_sel , uint8_t data , uint32_t address ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint8uint32Thunk';fcns.name{fcnNum}='DLLwriteRegisterS0_8'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8', 'uint32'};fcnNum=fcnNum+1;
%  es_status_codes DLLreadRegisterS0_32 ( uint32_t board_sel , uint32_t * data , uint32_t address ); 
...
%  es_status_codes DLLwriteRegisterS0_32 ( uint32_t board_sel , uint32_t data , uint32_t address ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint32uint32Thunk';fcns.name{fcnNum}='DLLwriteRegisterS0_32'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint32', 'uint32'};fcnNum=fcnNum+1;
%  es_status_codes DLLsetBitS0_32 ( uint32_t board_sel , uint32_t bitnumber , uint16_t address ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint32uint16Thunk';fcns.name{fcnNum}='DLLsetBitS0_32'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint32', 'uint16'};fcnNum=fcnNum+1;
%  es_status_codes DLLresetBitS0_32 ( uint32_t board_sel , uint32_t bitnumber , uint16_t address ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint32uint16Thunk';fcns.name{fcnNum}='DLLresetBitS0_32'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint32', 'uint16'};fcnNum=fcnNum+1;
%  void DLLStart2dViewer ( UINT32 drvno , UINT32 cur_nob , UINT16 cam , UINT16 pixel , UINT32 nos ); 
...
%  void DLLShowNewBitmap ( UINT32 drvno , UINT32 cur_nob , UINT16 cam , UINT16 pixel , UINT32 nos ); 
...
%  void DLLSetGammaValue ( UINT16 white , UINT16 black ); 
