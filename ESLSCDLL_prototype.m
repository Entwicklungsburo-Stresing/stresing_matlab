...
%This function was generated by loadlibrary.m parser version  on Thu May  4 14:17:14 2023
...
%  es_status_codes DLLReturnFrame ( uint32_t board_sel , uint32_t sample , uint32_t block , uint16_t camera , uint16_t * pdest0 , uint16_t * pdest1 , uint32_t pixel ); 
...
%  es_status_codes DLLDAC8568_setAllOutputs ( uint32_t board_sel , uint8_t location , uint8_t cameraPosition , uint32_t * output0 , uint32_t * output1 , uint32_t * output2 , uint32_t * output3 , uint32_t * output4 , uint8_t reorder_channel ); 
fcns.thunkname{fcnNum}='es_status_codesuint32uint8uint8voidPtrvoidPtrvoidPtrvoidPtrvoidPtruint8Thunk';fcns.name{fcnNum}='DLLDAC8568_setAllOutputs'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='es_status_codes'; fcns.RHS{fcnNum}={'uint32', 'uint8', 'uint8', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint32Ptr', 'uint8'};fcnNum=fcnNum+1;
